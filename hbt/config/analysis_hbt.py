...
from cmsdb.campaigns.run2_2018_nano_uhh_v12 import campaign_run2_2018_nano_uhh_v12
...
# v11 uhh config 2018 with limited number of files for faster prototyping
add_config_run2ul(
    analysis_hbt,
    campaign_run2_2018_nano_uhh_v12.copy(),
    config_name=f"{campaign_run2_2018_nano_uhh_v12.name}_limited",
    config_id=33,
    limit_dataset_files=2,
)
